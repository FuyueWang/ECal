...
void TMVARegression( TString myMethodList = "" )
{
   ...
   // dataloader->AddVariable( "var2", "Variable 2", "units", 'F' );
	...
	dataloader->AddVariable( "ch[0]", "Variable 1", "units", 'D' );
   dataloader->AddVariable( "ch[1]", "Variable 2", "units", 'D' );
   dataloader->AddVariable( "ch[2]", "Variable 3", "units", 'D' );
   dataloader->AddVariable( "ch[3]", "Variable 4", "units", 'D' );
   dataloader->AddVariable( "ch[4]", "Variable 5", "units", 'D' );
   dataloader->AddVariable( "ch[5]", "Variable 6", "units", 'D' );
   dataloader->AddVariable( "ch[6]", "Variable 7", "units", 'D' );
   dataloader->AddVariable( "ch[7]", "Variable 8", "units", 'D' );
   dataloader->AddVariable( "ch[8]", "Variable 9", "units", 'D' );
   // dataloader->AddVariable( "ch[9]", "Variable 10", "units", 'D' );
	// dataloader->AddVariable( "ch[10]", "Variable 11", "units", 'D' );
   // dataloader->AddVariable( "ch[11]", "Variable 12", "units", 'D' );
   ...
   TFile *input(0);
   TString fname = "../../../data/ecalpos/rootdata/linttraincutID.root";
   ...
   TTree *regTree = (TTree*)input->Get("inttree");
   ...
   dataloader->PrepareTrainingAndTestTree( mycut,
                                         "nTrain_Regression=700000:nTest_Regression=0:SplitMode=Random:NormMode=NumEvents:!V" );
   //
   //     dataloader->PrepareTrainingAndTestTree( mycut,
   ...
   // Neural network (MLP)
   if (Use["MLP"])
      factory->BookMethod( dataloader,  TMVA::Types::kMLP, "MLP", "!H:!V:VarTransform=Norm:NeuronType=tanh:NCycles=500:HiddenLayers=16,15,64,128,76,51,38,22,13:TestRate=6:TrainingMethod=BFGS:Sampling=0.3:SamplingEpoch=0.8:ConvergenceImprove=1e-6:ConvergenceTests=15:!UseRegulator" );
   ...
   if (Use["DNN_CPU"]) {
       ...
       */
      TString layoutString("Layout=TANH|64,LLayout=TANH|128,ayout=TANH|32,Layout=TANH|64,Layout=TANH|128,Layout=TANH|100,Layout=TANH|50,Layout=TANH|64,LLayout=TANH|32,LINEAR");
