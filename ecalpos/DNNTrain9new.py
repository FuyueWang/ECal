...
for learni in range(1,4):
    ...
    with tf.Session() as sess:
        ...
        while iter<Nbofiter:
            ...
            inputy=np.array(traindf['standPosy'].iloc[startbatch*batchsize:(startbatch+1)*batchsize]).reshape(batchsize,1)
            ...
            if iter % PrintCount==0:
                ...
                testinputy=np.array(traindf['standPosy'].iloc[trainsize:trainsize+testsize]).reshape(testsize,1)
